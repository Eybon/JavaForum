 ...
 */
public class ThirdPersonMessage extends Message {

    public ThirdPersonMessage(String content, String username, SujetDiscussion chanel) throws RemoteException {
        super(content, username, chanel);
    }

    public ThirdPersonMessage(String id, String username, String content, LocalDateTime date, SujetDiscussion chanel) throws RemoteException {
